...
if __name__ == "__main__":  
    for date in dates:
        ...
        for i in range(num_prefs):
            ...
            y_ticks1=np.around(np.arange(y_min, y_max, 0.2), decimals=1)
        ...
        plt.savefig(f'{figure_res}/L1D_Accuracy.png',dpi=800, format="png", bbox_inches='tight') 
        plt.savefig(f'{figure_res}/L1D_Accuracy.pdf',dpi=800, format="pdf", bbox_inches='tight') 
        plt.close()   
