...
metrics=['L1D Accuracy','L1D Coverage','L2C Accuracy','L2C Coverage']
legends={"ipcp_isca2020":"IPCP",
         "mlop_dpc3":"MLOP",
         "vberti":"Berti",
         "hyperion_hpc_2table_UTBh1_buffer8_8":"Hyperion",
         "bingo_dpc3":"Bingo",
         "ppf":'SPP-PPF'}
...
if __name__ == "__main__":  
    for date in dates:
        ...
        y_ticks=np.around(np.arange(1.0, 1.801, 0.1), decimals=1)
        y_ticks1=np.around(np.arange(1.0, 1.801, 0.2), decimals=1)

        ax.set_ylim(1.0, 1.801)
        ax_idx = 0
        for item in y_ticks:
            if(ax_idx % 2 == 0):
        ...
        ax.set_title('(a) SpeedUp', y=0.86, fontsize=fontsizes+1) 
        ...
        for metric in metrics:
            ...
            if(metric == 'L1D Accuracy'):
                ...
                axs.set_title('(c) L1D Coverage', y=0.74, fontsize=fontsizes+1) 
            elif(metric == 'L2C Accuracy'):
                axs.set_title('(d) L2C Accuracy', y=0.74, fontsize=fontsizes+1) 
            elif(metric == 'L2C Coverage'):
                axs.set_title('(e) L2C Coverage', y=0.74, fontsize=fontsizes+1) 
