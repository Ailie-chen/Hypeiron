...
#     
    ...
    #("1core_spec2k17_compare_mem_tense","output_prefetchers"),
     (f"thresh_spec","output_prefetchers"),
    #  (f"1core_gap_compare_mem_tense","output_prefetchers"),
    #  (f"1core_ligra_compare_mem_tense","output_prefetchers"),
    #  (f"1core_cs_compare_mem_tense","output_prefetchers"),
