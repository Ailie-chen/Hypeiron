...
ax.bar(left_bar_pos1 + bar_width * 1.0, Bdata, edgecolor ="#4472C4",width= bar_width, label = 'Coverage',hatch="",facecolor="#4472C4",zorder=2)
ax.bar(left_bar_pos1 + bar_width * 2.0, Cdata, edgecolor ="#ED7D31",width= bar_width, label = 'Accuracy',hatch="",facecolor="#ED7D31",zorder=2)
