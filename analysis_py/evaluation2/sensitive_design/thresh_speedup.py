...
ax1.text(0.5, -0.30, '(a)Thresholds for memory pages', transform=ax1.transAxes, fontsize=9,  va='top', ha='center')
ax2.text(0.5, -0.30, '(b)Thresholds for PCs', transform=ax2.transAxes, fontsize=9, va='top', ha='center')
