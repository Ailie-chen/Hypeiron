...
figure_res = 'analysis_py/evaluation_cyj/sensitive_design/'
...
ax.plot(left_bar_pos, speedup, linestyle='-', marker='o', markerfacecolor="#4472C4",color="#4472C4", linewidth=1,markersize=2.5,zorder=2) 
ax2 = ax.twinx()
ax2.plot(left_bar_pos, accuracy, linestyle='-', marker='s', markerfacecolor="#ED7D31",color="#ED7D31", linewidth=1,markersize=2.5,zorder=2) 

legend_patch = []
legend_patch.append(Line2D([0], [0], linestyle='-', marker='o', markerfacecolor="#4472C4",color="#4472C4", lw=1, markersize=2.5, label='Speedup'))
legend_patch.append(Line2D([0], [0], linestyle='-', marker='s', markerfacecolor="#ED7D31", color="#ED7D31", lw=1, markersize=2.5, label='Accuracy'))
...
ax.set_yticklabels(['{:.2f}'.format(item-1.0) for item in np.arange(155, 161,1)/100],fontsize=9,ha='right')
