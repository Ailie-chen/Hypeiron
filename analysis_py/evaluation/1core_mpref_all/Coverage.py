...
if __name__ == "__main__":  
    for date in dates:
        ...
        for trace in traces:
            ...
            axes[ax, ay].set_xticklabels(['L2','LLC'], fontsize=8)
            ...
            if(max_v < 0.5):
                ...
                y_ticks = np.around(np.arange(0, 1.01, 0.2), decimals=2)
                y_ticks1 = np.around(np.arange(0, 1.01, 0.1), decimals=2)
                min_v = 0
                max_v = 1.0
            ...
            if(ay == 0):
                axes[ax,ay].set_ylabel("Coverage", fontsize=8)
