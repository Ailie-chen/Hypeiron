...
markers=['o','d','d','o','s','s','o','s','s','o','s','s']
markerfacecolors=['white','white','white','grey','grey','grey','lightgrey','lightgrey','lightgrey','black','black','black']
...
if __name__ == "__main__":  
    for date in dates:
        ...
        ## 设置图像保存的路径
        figure_res='analysis_py/evaluation/speedup_storage/'
        ...
        ax.set_xlabel('Storage Overhead', fontsize=8)
