...
main()
{
    ...
    source_file="ChampSim/Berti/batch_prefetcher/hyperion_hpc_aDiGHB_UTBh1_buffer9_3.l1d_pref"
    cp "ChampSim/Berti/prefetcher/hyperion_hpc_2table_UTBh1_buffer9_3.l1d_pref" "$source_file"
      ...
      for pc_page in "${MULS[@]}"; do
        for mpc in "${MUL[@]}"; do
          for mpage in "${MUL[@]}"; do
            ...
            if [ $pcn -eq 128 ]&&[ $pc_page -eq 3 ]; then
              continue
            fi
